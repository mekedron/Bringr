...
/// Bringr's own most-recently-used order for apps and per-app windows, persisted so
...
final class RecencyTracker {
    ...
    /// real usage (an external ⌘-Tab switch or a prior Bringr commit), captured before any
