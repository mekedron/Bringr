...
/// Manages whether PieSwitcher launches automatically at login.
///
...
final class LaunchAtLoginManager: ObservableObject {
    /// Whether PieSwitcher is currently registered as an enabled login item.
    @Published private(set) var isEnabled: Bool

    private let probe: () -> Bool
    private let register: () throws -> Void
    private let unregister: () throws -> Void
    private let log = Logger(subsystem: "com.mekedron.PieSwitcher", category: "LaunchAtLogin")
