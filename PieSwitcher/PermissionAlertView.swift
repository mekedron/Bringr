...
struct PermissionAlertView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text(
                "PieSwitcher may have lost Accessibility access after a rebuild. macOS resets "
    ...
    private var manualSteps: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                step("3", "Find PieSwitcher in the list and remove it (select it, click \u{2013})")
                step("4", "Click + to add PieSwitcher again, then turn its switch on")
            }
            .font(.subheadline)
        }
        .padding(12)
