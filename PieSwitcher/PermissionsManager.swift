...
enum PermissionStatus: Equatable {
    ...
    var detail: String {
        switch self {
        case .granted:
            return "PieSwitcher can read and control windows and observe global input."
        case .denied:
            return "PieSwitcher needs Accessibility access to enumerate windows, switch "
...
/// Observes and requests the Accessibility permission PieSwitcher needs.
///
